...
　　
 ...
 <td> <input type="button" size="15" value="회원가입" onclick="javascript:window.location='../test2/InputForm.jsp'"></td>
...
<ul>
	...
	<li onclick="javascript:window.location='../reserve/ReserveForm.jsp'"><a href="#">예약하기　&nbsp;&nbsp;</a></li>

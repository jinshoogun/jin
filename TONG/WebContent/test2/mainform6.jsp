  ...
  <table width=500 height="250" align="center" border="1">
         <tr>
           ...
           <td align="center">
             ...
             <td align="center">
             <form  method="post" action="../admin/adminLoginout.jsp">
             ...
             <%if (((String)session.getAttribute("a_id")).equals("SuperAdmin")){%>
              <br/><input type="button" value="관리자 추가, 삭제, 변경" onclick="javascript:window.location='../admin/adminModify.jsp'" ><br>
              <br/><input type="button" value="회원정보 수정 및 탈퇴"  onclick="javascript:window.location='../admin/userModify.jsp'" ><br>
              <br/><input type="button" value="디자이너 정보 수정 및 탈퇴"  onclick="javascript:window.location='../admin/designerModify.jsp'" ><br>

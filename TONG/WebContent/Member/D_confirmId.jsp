...
<%
  ...
  int check = designer.D_confirmId(id);  // check변수를 선언하고.DAO confirmId함수에서 얻은 결과를 가져옴
		...
		<tr bgcolor="white">
			<td align="center">
				<p>
					...
					<%=id%>
					는 사용하실수 있는 ID입니다.
				</p> <input type="button" value="닫기" onclick="setD_id()">
			</td>
		</tr>
	</table>
...
<script language="javascript">
    ...
    function setD_id()  <% //setid()함수 , 자바스크립트의 opener 메소드 

...
%>
<body>
<form method="post" action="adminModifyPro.jsp" name="admin" onsubmit="return checkIt()">
  <table width="700" border="1" cellspacing="0" cellpadding="3"  align="center">
    ...
    <tr> 
     ...
     <tr> 
      ...
      <td width="500"> 
        <input type="password" name="password" size="10" value="<%=dto.getA_password()%>">
      </td>
    <tr>  
    <tr> 
   ...
   <tr> 
      ...
      <td width="500">
          <input type="text" name="email" size="40" maxlength="30" value="<%=dto.getA_email()%>">	
      </td>
      <tr> 
      <td width="200">전화번호</td>
      <td width="500">
          <input type="text" name="phone" size="40" maxlength="30" value="<%=dto.getA_phone()%>">	
      </td>
    </tr>
      <td> 

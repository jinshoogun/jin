...
<table width="450" border="1" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td  width="100"   align="center" >디자이너 닉네임</td>
   <td  width="330">
       <input type="text" size="40" maxlength="20" name="Style_Nickname" ></td>  <%--디자이너 닉네임 입력 --%>
  </tr>
  
  <tr>
    <td  width="100"   align="center" >디자이너 아이디</td>
   <td  width="330">
       <input type="text" size="40" maxlength="20" name="Style_storeid" ></td>  <%--디자이너 닉네임 입력 --%>
  </tr>
...
<tr>      
 <td colspan=2  align="center"> 
  ...
  <input type="button" value="목록보기" OnClick="window.location='../test2/mainform6.jsp'">
</td></tr></table>    

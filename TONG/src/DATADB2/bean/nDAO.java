    ...
    throws Exception {
        ...
        try {
            ...
            pstmt = conn.prepareStatement(
            		"select n_num,n_writer,n_subject,n_content,n_password,n_readcount,n_reg_date,n_ref,n_re_step,n_re_level,r "+
        					"from (select n_num,n_writer,n_subject,n_content,n_password,n_readcount,n_reg_date,n_ref,n_re_step,n_re_level,rownum r " +
        					"from (select n_num,n_writer,n_subject,n_content,n_password,n_readcount,n_reg_date,n_ref,n_re_step,n_re_level " +
        					"from notice order by n_ref desc, n_re_step asc) order by n_ref desc, n_re_step asc ) where r >= ? and r <= ? ");
